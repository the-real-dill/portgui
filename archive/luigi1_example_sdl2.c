...
UIWindow *UIInitialiseSDL() {
	...
	cursors[UI_CURSOR_RESIZE_UP] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENS);
	cursors[UI_CURSOR_RESIZE_LEFT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZEWE);
	cursors[UI_CURSOR_RESIZE_UP_RIGHT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENESW);
	cursors[UI_CURSOR_RESIZE_UP_LEFT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENWSE);
	cursors[UI_CURSOR_RESIZE_DOWN] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENS);
	cursors[UI_CURSOR_RESIZE_RIGHT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZEWE);
	cursors[UI_CURSOR_RESIZE_DOWN_LEFT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENESW);
	cursors[UI_CURSOR_RESIZE_DOWN_RIGHT] = SDL_CreateSystemCursor(SDL_SYSTEM_CURSOR_SIZENWSE);
